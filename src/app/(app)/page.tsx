        ...
        <div className="p-6 space-y-6">
            <div>
                <h1 className="text-3xl font-bold text-gray-900">
                    Привет! Добро пожаловать в Vibe Learn
                </h1>
                <p className="mt-2 text-gray-600 ">
                    Ваша персональная платформа для структурирования учебных
                    материалов и отслеживания прогресса
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {stats?.completedLessons || 0} из{' '}
                            {stats?.totalLessons || 0} уроков
                        </p>
                    </CardContent>
                </Card>
