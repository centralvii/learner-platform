    ...
    achievements: [
        {
            id: 1,
            title: 'Первые шаги',
            description: 'Начал изучение первого курса',
            earned: true,
        },
        {
            id: 2,
            title: 'Настойчивость',
            description: 'Изучал 3 дня подряд',
            earned: true,
        },
        {
            id: 3,
...
export default function ProgressPage() {
    ...
    const handleContinue = (course: any) => {
        if (course.lastAccessedLessonId) {
            router.push(
                `/courses/${course.id}/lessons/${course.lastAccessedLessonId}`
            );
        }
    };
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            {progressData.completedLessons} из{' '}
                            {progressData.totalLessons} уроков
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {
                                progressData.courseProgress.filter(
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {Math.round(progressData.totalStudyTime / 60)}ч
                        </div>
                        <p className="text-xs text-muted-foreground">
                            {progressData.thisWeekTime} мин на этой неделе
                        </p>
                    </CardContent>
                </Card>
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    <Button
                                        ...
                                        disabled={!course.lastAccessedLessonId}
                                    >
                                        Продолжить
                                    </Button>
                                </div>
